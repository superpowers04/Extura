...
public class WardrobeScreen extends AbstractPanelScreen {
	...
	protected void init() {
		...
		// version
		final String buildVersion = FiguraMod.VERSION.noBuildString();
		MutableComponent versionText = Component.literal("Extura").append(", Compatible with " + buildVersion).withStyle(ChatFormatting.ITALIC);
	...
	private void uploadAvatar(Destination destination) {
	...
	private void deleteAvatar(Destination destination) {
