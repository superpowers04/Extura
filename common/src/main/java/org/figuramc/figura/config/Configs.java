...
public class Configs {
	...
	public static final ConfigType.BoolConfig
			...
			INVENTORY_SCISSOR = new ConfigType.BoolConfig("inventory_scissor", RENDERING, false);
	...
	public static final ConfigType.BoolConfig SYNC_PINGS = new ConfigType.BoolConfig("sync_pings", DEV, false) {{
